...
urlpatterns = [
    ...
    path('journals_delete/<key>/', user_views.journal_deleteOne,name='journal_deleteOne'),
    path('journals_delete/', user_views.journal_delete, name='journal_delete'),
    ...
    path('quality-assessment-questions/',user_views.quality_assessment_questions,name="qualityAssessmentQuestions"),
    path('quality-assessment-questions/<key>/', user_views.delete_quality_assessment_questions,name="qualityAssessmentQuestions"),
